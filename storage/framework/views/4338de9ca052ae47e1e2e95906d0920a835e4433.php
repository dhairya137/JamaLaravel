    ...
    <!-- <div class="row gray-section no-margin">
        <div class="container">                
            <div class="col-md-6 content-block">
                ...
                <div class="title-divider"></div>
                <p>Whether riding in the backseat or driving up front, every part of the <?php echo e(config('constants.site_title', 'Thinkin Cab')); ?> experience has been designed around your safety and security.</p>
...
<!--<div class="row find-city">
    ...
    <!-- <div class="row find-city no-margin">
        <div class="container">
            <h2><?php echo e(config('constants.site_title','Thinkin Cab')); ?> is in your city</h2>
            <form>
                <div class="input-group find-form">
