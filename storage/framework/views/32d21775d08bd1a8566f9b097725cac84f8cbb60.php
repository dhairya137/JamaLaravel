            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li id="first-button" <?php if($errors->has('login_type') && $errors->first('login_type') == 'dispute'): ?>  class="active" <?php endif; ?>><a href="#dispute" role="tab" data-toggle="tab">Dispute</a></li>
                    </ul>
